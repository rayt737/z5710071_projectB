...
data_files = [str(p.relative_to(ROOT)) for p in ROOT.rglob("*")
              ...
              # src/lexicons/ is deliberately committed (LM dictionary + our
              # finVADER-lite extension); see .gitignore and ai/prompt_log.md.
              and not ("src" in p.parts and "lexicons" in p.parts)]
